            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $user = [
                    ...
                    [
                        ...
                        "telephone" => "+1 313-779-4314",
                        "email" => "jimmy.fallan@smartadminwebapp.com",
                        "address" => "5 Smyth Rd, Detroit, MI, 48341, USA",
                        "tags" => "jimmy fellan",
                        "id" => "7"
                    ]
                        ];
                ...
                ?>
                <div class="col-xl-4">
                    <div id=""<?php echo "$item[id]"?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo "$item[tags]"?>">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?php echo "$item[telephone]"?></a>
